    ...
    <div className="min-h-screen flex">
        ...
        >
          <div className="text-center">
            <motion.div 
              ...
              className="mx-auto h-16 w-16 bg-primary-500 rounded-full flex items-center justify-center mb-6"
            >
              <User className="h-8 w-8 text-white" />
            </motion.div>
            <h2 className="text-3xl font-bold text-gray-900 mb-2">User Login</h2>
            <p className="text-gray-600">Access your GreenCycle account</p>
          </div>
      ...
      <div className="hidden lg:block relative w-1/2">
        ...
        <div className="relative z-10 flex flex-col justify-center h-full px-12 text-white">
          ...
          >
            <Leaf className="h-16 w-16 mb-8" />
            <h1 className="text-4xl font-bold mb-6">
              Welcome to GreenCycle
            </h1>
            <p className="text-xl mb-8 text-primary-100">
              Join our community of eco-conscious users making a difference through responsible e-waste management.
            </p>
            <ul className="space-y-4 text-primary-100">
              <li className="flex items-center">
                <div className="w-2 h-2 bg-primary-200 rounded-full mr-3"></div>
                Upload and track your electronic devices
              </li>
              <li className="flex items-center">
                <div className="w-2 h-2 bg-primary-200 rounded-full mr-3"></div>
                Connect with certified NGOs for device pickup
              </li>
              <li className="flex items-center">
                <div className="w-2 h-2 bg-primary-200 rounded-full mr-3"></div>
